...
while True:
    # Game setup
    sonarDevices = ""
    while not sonarDevices.isdigit():
        sonarDevices = input('How many sonar devices would you like to receive:  ')

    theBoard = getNewBoard()

    numChests = ""
    while not numChests.isdigit():
        numChests = input('How many secret treasure chests would you like to find:  ')
    theChests = getRandomChests(int(numChests))

    drawBoard(theBoard)
    previousMoves = []

    sonarDevices = int(sonarDevices)
